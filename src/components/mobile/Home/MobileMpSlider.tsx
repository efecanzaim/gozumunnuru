...
const mpSliderItems = [
    ...
    {
        id: 4,
        imageUrl: "https://cdn.beymen.com/bannerimages/App2_2025111808292826532.jpg",
        link: "https://www.beymen.com/tr/yasam-stil-onerisi-secili-kol-saati-tasarimlari-109874",
        alt: "Kol Saati Tasarımları"
    }
];
    ...
    return (
        <div className="o-mpSliderWrapper">
            <div className="o-mpSliderItems">
                ...
                <div className="mp-slider-scrollbar swiper-scrollbar"></div>
            </div>
        </div>
    );
};
